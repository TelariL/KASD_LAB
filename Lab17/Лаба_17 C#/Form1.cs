...
namespace Lab17
{
    public partial class Form1 : Form
    {
        ...
        private void RemoveOperation(double[] arrayListResults, double[] linkedListResults)
        {
            ...
            for (int size = 10; size <= 100000; size *= 10)
            {
                ...
                for (int i = 0; i < 20; i++)
                {
                    ...
                    stopwatch.Start();
                    arrayList.removeIndex(size / 2);
                    stopwatch.Stop();
                    arrayListTotalTime += stopwatch.ElapsedMilliseconds;

                    stopwatch.Restart();
                    linkedList.Remove(linkedList.Get(size / 2));
                    stopwatch.Stop();
                    linkedListTotalTime += stopwatch.ElapsedMilliseconds;
        ...
        private void GraphResults(double[] arrayListResults, double[] linkedListResults)
        {
            ...
            pane.AddCurve("ArrayList", arrayListPoints, Color.LawnGreen, SymbolType.Circle);
            pane.AddCurve("LinkedList", linkedListPoints, Color.MediumPurple, SymbolType.Circle);
